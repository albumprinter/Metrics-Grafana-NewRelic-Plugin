    ...
    return {
        ...
        execute: function() {
            NewRelicDatasource = (function () {
                ...
                NewRelicDatasource.prototype.getApplications = function (value, extResult) {
                    var _this = this;
                    if (value === void 0) { value = 1; }
                    if (extResult === void 0) { extResult = []; }
                    var request = {
                    ...
                    return this.makeApiRequest(request)
                        ...
                        if (result && result.response && result.response.applications && result.response.applications.length > 0) {
                            return _this.getApplications(value + 1, result.response.applications).then(function (resultInt) {
